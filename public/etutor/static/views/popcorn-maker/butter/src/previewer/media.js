  ...
  define( [ "core/logger", "core/eventmanager" ], function( Logger, EventManager ) {
    ...
    var Media = function ( mediaData ) {
      ...
      this.alterMediaHTML = function( rootNode ) {
        ...
        if ( that.type === "object" ) {
          /*var parentNode = 'video';
          var newNode = document.getElementById( that.target ).cloneNode( true );
      ...
      this.generatePopcornString = function( options ) {
        ...
        var players = {
          ...
          "object": function() { //alert(that.mediaElement.id);// bugfix xxx that mediaElement.id
            return "var popcorn = Popcorn( '#video'" + popcornOptions + ");\n";
          }
        };
