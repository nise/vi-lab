...
""+e+".jpg";c.onerror=function(){this.style.display="none"}},h=document.getElementsByClassName("vi2-timeline-main");h[0].removeEventListener("mousemove",f);h[0].addEventListener("mousemove",f)},createTimelineSlidePreview:function(){},addTimelineMarkers:function(a,b,e){var c=this;void 0===e&&(e=this.options.timelineSelector);this.options[a]={markerHasTooltip:!0,markerIsClickable:!0};var f=$(e);$("."+a+"-timeline-marker").each(function(a,b){$(b).remove()});$.each(b,function(b,h){var k=h.occ[0]/vi2.observer.player.duration(),
k=k*$(e).width();isNaN(k)||k>$(e).width()||(k=$("<a></a>").addClass(a+"-timeline-marker ttoc").attr("style","left:"+k+"px;"),c.options[a].markerHasTooltip&&k.attr("title",h.name).attr("data-toggle","tooltip"),c.options[a].markerIsClickable&&k.bind("click",function(b){vi2.observer.player.currentTime(h.occ[0]);vi2.observer.log({context:a,action:"timeline-link-click",values:[h.name,h.author,h.occ[0]]})}),f.append(k))})},handleDurationChange:function(a){this.createTimelineControl();vi2.observer.player.currentTime(this.seek);
$(vi2.observer).trigger("player.ready",[vi2.observer.player.seqList[vi2.observer.player.seqNum].id,vi2.observer.player.seqNum])},handleProgress:function(a){var b=this.video;percent=null;b&&b.buffered&&0<b.buffered.length&&b.buffered.end&&b.duration?percent=b.buffered.end(0)/b.duration:b&&void 0!==b.bytesTotal&&0<b.bytesTotal&&void 0!==b.bufferedBytes?percent=b.bufferedBytes/b.bytesTotal:a&&(a.lengthComputable&&0!==a.total)&&(percent=a.loaded/a.total);null!==percent&&(this.percentLoaded=percent,percent=
Math.min(1,Math.max(0,percent)),this.video_loading_progress&&this.video_seek&&this.video_loading_progress.width(this.video_seek.width()*percent))},handleTimeupdate:function(a){this.seeksliding||this.video_seek.slider("value",vi2.observer.player.currentTime())}});
...
function timeDifference(a,b,e){alert(1);var c=moment(a);alert(2);a=moment(a);alert(3);var f=a.diff(c,"seconds");if(60>=f)return b+f.toFixed(1)+"s"+e;f=a.diff(c,"minutes");if(60>=f)return b+f.toFixed(1)+"min"+e;f=a.diff(c,"hours",!0);if(24>=f)return b+f.toFixed(1)+"h"+e;f=a.diff(c,"days",!0);if(30>f)return b+f.toFixed(1)+"d"+e;f=a.diff(c,"months",!0);if(12>f)return b+f.toFixed(1)+"m"+e;f=a.diff(c,"years",!0);return b+f.toFixed(1)+"y"+e}
Object.size=function(a){var b=0,e={};for(e in a)a.hasOwnProperty(e)&&b++;return b};Vi2.Utils=$.inherit({__constructor:function(a){},name:"utils",seconds2decimal:function(a){d=Number(a);a=Math.floor(d/3600);var b=Math.floor(d%3600/60),e=Math.floor(d%3600%60);return(0<a?a+":":"")+(0<b?(0<a&&10>b?"0":"")+b+":":"00:")+(10>e?"0":"")+e},deci2seconds:function(a){if(0>Number(a)||void 0===a)return 0;a=a.split(":");return 3600*Number(a[0])+60*Number(a[1])+Number(a[2])}});
...
function(b){b=vi2.observer.player.currentTime();var e=Number(Number(b)-Number(a.options.step));alert(e);vi2.observer.log({context:"skipBack",action:"skip-back",values:[b,String(e)]});vi2.observer.player.currentTime(e)}).prependTo(this.options.selector)}});
